...
class team extends Component {
    ...
    members = members.map((member) => {
      ...
      return (
        <div key={member.id} className="text-center">
          <div>
            {title === 'Head of Career Development Centre' ||
            title === 'Director' ||
            title === 'Faculty Incharge' ||
            title === 'Overall Co-ordinators' ||
            title === 'Head Co-ordinators' ? (
              <div>
                <div>
                      ...
                      <div className="photobox photobox_type9">
                        <div className="photobox__previewbox shadow p-3 mb-5 bg-white rounded">
                          <img
                            ...
                            width="270"
                            height="270"
                            class=" photobox__preview member-image"
                            alt={member.name}
                          ></img>
                ...
                <div className="domain">
                  {member.domain === 'pr' ? (
                    ...
                    >
                      <i>(Public Relation and Marketing)</i>
                    </p>
                  ) : null}
                  {member.domain === 'tech' ? (
                    <p
      ...
      <div key={type}>
        ...
        title === 'Head Co-ordinators' ? (
          <h2
            ...
            className="position shadow p-3 mb-5 bg-white rounded"
          >
            {title}
          </h2>
        ) : (
          <h2
            style={{ marginTop: '70px' }}
            className="position-exec shadow p-3 mb-5 bg-white rounded"
          >
            {title}
          </h2>
        )}
  ...
  render() {
    ...
    for (let type in this.state.members) {
      ...
      switch (type) {
        case 'Director':
          final_html['Director'] = this.members_html('Director', members, type);
          break;
        ...
        case 'Manager_spons':
          ...
          break;
        case 'Executive_pr':
          final_html['Executive_pr'] = this.members_html(
        ...
        case 'Executive_tech':
          final_html['Executive_tech'] = this.members_html(
        ...
        case 'Executive_des':
          final_html['Executive_des'] = this.members_html(
        ...
        case 'Executive_doc':
          final_html['Executive_doc'] = this.members_html(
        ...
        case 'Executive_spons':
          final_html['Executive_spons'] = this.members_html(
    ...
    return (
      <div className="team-whole">
        ...
        {/* <div className="team-div">
          <Link
            className="team-links shadow p-3 mb-5 bg-white rounded"
            to="/team/yearwise"
          >
            Previous Year Teams
          </Link>
        ...
        <div style={{ marginBottom: '20px' }} className="team-year">
          <p className="text-center">
            Team of {this_year}-{this_year - 2000 + 1}
          </p>
        </div>
        {this.state.loading ? (

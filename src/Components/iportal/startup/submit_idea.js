...
class submitIdea extends Component {
    ...
    _register_idea = e => {
        ...
        reqType(url, {
            ...
            'course':this.state.pfsn==="Student"?this.course.value:null,
            'branch':this.state.pfsn==="Student"?this.branch.value:null,
            'semester':this.state.pfsn==="Student"?this.semester.value:null,

                ...
                <div className="row">
                    ...
                    <div className="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                      ...
                      <p style={{fontSize:"40px"}}>
                        <a href="https://www.facebook.com/ecellnitrr/" rel="noopener noreferrer" target="_blank"><i className="fab fa-facebook-square"></i></a>
                        <a href="https://www.instagram.com/ecell.nitraipur/" rel="noopener noreferrer" target="_blank"><i className="fab fa-instagram"></i></a>
                        <a href="https://twitter.com/ecellnitrr?lang=en" rel="noopener noreferrer" target="_blank"><i className="fab fa-twitter-square"></i></a>
                        <a href="https://in.linkedin.com/company/entrepreneurship-cell-nit-raipur" rel="noopener noreferrer" target="_blank"><i className="fab fa-linkedin"></i></a>
                      </p>

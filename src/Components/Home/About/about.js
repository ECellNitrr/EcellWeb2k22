        ...
        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
          ...
          <div className="text-section">
            ...
            <p className="text-5">
              ...
              resources such as new ideas, funding mentoring, other mentorship
              programs, workshops to help them organize their strategy and
              frequent, highly interactive speaker sessions and lecture series.
            </p>
          </div>
        </div>
      </div>
